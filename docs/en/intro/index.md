...
1. Read [Why This Book](/en/intro/why-this-book).
2. Pick a reading path in [How To Read](/en/intro/how-to-read).
3. Read [Import, Packaging, and Environment](/en/intro/import-packaging-and-environments) for import and project-layout fundamentals.
4. Read [Web Gateway Evolution: CGI, WSGI, ASGI](/en/intro/web-gateway-evolution) for server/app history.
5. Keep [Python 3.10~3.14 Deep Dive](/en/python-3.10-3.14-deep-dive) nearby as release-history context.
